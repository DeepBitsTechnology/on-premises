...
### 4. Use Let's Encrypt to Create and Install HTTPS Certificates for Your Application:
...
### 5. Modify the `.env` File
    - Update the `.env` file with the following details:
      ...
      - **CERTIFICATE_PATH**: The path of the folder that contains the `privkey.pem` and `fullchain.pem` files generated by Certbot.
